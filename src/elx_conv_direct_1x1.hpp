...
class elx_conv_direct_1x1_t : public elx_conv_t<UserTypes> {
  ...
  gemm_kernel_binder::ker<itf_gemm::FP32> *ker_gemm_I_O_T_;
  gemm_kernel_binder::ker<itf_gemm::FP32> *ker_gemm_I_O_Tr_;
  gemm_kernel_binder::ker<itf_gemm::FP32> *ker_gemm_I_OrT_;
  gemm_kernel_binder::ker<itf_gemm::FP32> *ker_gemm_I_OrTr_;
  gemm_kernel_binder::ker<itf_gemm::FP32> *ker_gemm_IrO_T_;
  gemm_kernel_binder::ker<itf_gemm::FP32> *ker_gemm_IrO_Tr_;
  gemm_kernel_binder::ker<itf_gemm::FP32> *ker_gemm_IrOrT_;
  gemm_kernel_binder::ker<itf_gemm::FP32> *ker_gemm_IrOrTr_;
