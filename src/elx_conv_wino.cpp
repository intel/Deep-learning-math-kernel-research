...
#pragma omp for nowait collapse(6) schedule(static)
  ...
  for_each (_I2, this->I2) {
    ...
    for_each (_iV, V) {
      if (I == ISA_SKX_AVX512 && std::is_same<Type, float>::value) {
        auto *ptarget
          = &md10(atweights, _oc4, _ic4, _oc3, _ic3, _wA, _hA, _O2, _I2, _iV, 0);
        if (stream_wei_)
          _mm512_stream_ps(
              ptarget,
              *((__m512 *)&aout[_wA][_hA][_iV][0]));
...
#pragma omp for nowait collapse(6) schedule(static)
  ...
  for_each (_I2, this->I2) {
    ...
    for_each (_iV, V) {
      if (I == ISA_SKX_AVX512 && std::is_same<Type, float>::value) {
        auto *ptarget = &md10(
            atweights, _oc4, _ic4, _wA, _hA, _oc3, _ic3, _O2, _I2, _iV, 0);
        if (stream_wei_)
          _mm512_stream_ps(
              ptarget,
              *((__m512 *)&aout[_wA][_hA][_iV][0]));
  ...
  for_each (_I2, this->I2) {
    ...
    for_each (_iV, V) {
      if (I == ISA_SKX_AVX512 && std::is_same<Type, float>::value) {
        if (stream_wei_)
          _mm512_stream_ps(
              &md10(atweights, _oc4, _ic4, _wA, _hA, _oc3, _ic3, _O2, _I2, _iV, 0),
              *((__m512 *)&aout[_wA][_hA][_iV][0]));
        else
          _mm512_store_ps(
              &md10(atweights, _oc4, _ic4, _wA, _hA, _oc3, _ic3, _O2, _I2, _iV, 0),
    ...
    Type * __restrict tinput, Type * __restrict input, int _t2, int Tz)
{
  ...
  for_each (_T, Tz) {
    ...
    for_each (_hA, A) {
      if (I == ISA_SKX_AVX512 && std::is_same<Type, float>::value) {
        auto *ptarget = &md6(atinput, _wA, _hA, _ic3, _I2, _T, 0);
        if (stream_in_)
    ...
    Type *tinput, Type *input, int _t2, int _wA, int Tz)
{
  ...
  for_each (_T, Tz) {
    ...
    for_each (_hA, A) {
      if (I == ISA_SKX_AVX512 && std::is_same<Type, float>::value) {
        auto *ptarget = &md5(atinput, _hA, _ic3, _I2, _T, 0);
        if (stream_in_)
          _mm512_stream_ps(
