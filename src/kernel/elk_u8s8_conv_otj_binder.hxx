...
#include "src/kernel/elk_u8s8_conv_otj.hxx"

namespace euler {

struct u8s8_conv_kernel_binder {
  template <typename GarrayTypes, typename RoutputType, int V, int Vx, int I, int... Kp>
  using conv_ker_cls = typename euler::u8s8_conv_kernel_otj<GarrayTypes,
  ...
  DECL_U8S8_KCONV_TBL(INT8_F32, float, 16, 4, ISA_SKX_AVX512, 1, GKF_DCD); // direct, blocked, int8-conv
  DECL_U8S8_KCONV_TBL(INT8_F32, float, 16, 4, ISA_SKX_AVX512, 2, GKF_DCD);
  DECL_U8S8_KCONV_TBL(INT8_F32, int8_t, 16, 4, ISA_SKX_AVX512, 1, GKF_DCD);
  DECL_U8S8_KCONV_TBL(INT8_F32, int8_t, 16, 4, ISA_SKX_AVX512, 2, GKF_DCD);
  ...
  DECL_U8S8_KCONV_TBL(INT8_F32, float, 16, 4, ISA_SKX_AVX512, 1, GKF_FCD); // direct, nhwc->blocked, int8-conv
  DECL_U8S8_KCONV_TBL(INT8_F32, float, 16, 4, ISA_SKX_AVX512, 2, GKF_FCD);
  DECL_U8S8_KCONV_TBL(INT8_F32, int8_t, 16, 4, ISA_SKX_AVX512, 1, GKF_FCD);
  DECL_U8S8_KCONV_TBL(INT8_F32, int8_t, 16, 4, ISA_SKX_AVX512, 2, GKF_FCD);
  DECL_U8S8_KCONV_TBL(INT8_F32, uint8_t, 16, 4, ISA_SKX_AVX512, 1, GKF_FCD);
  DECL_U8S8_KCONV_TBL(INT8_F32, uint8_t, 16, 4, ISA_SKX_AVX512, 2, GKF_FCD);

  DECL_U8S8_KCONV_TBL(INT8_F32, float, 16, 4, ISA_SKX_AVX512, 1, GKF_DCF); // direct, blocked->nhwc, int8-conv
  DECL_U8S8_KCONV_TBL(INT8_F32, float, 16, 4, ISA_SKX_AVX512, 2, GKF_DCF);
  DECL_U8S8_KCONV_TBL(INT8_F32, int8_t, 16, 4, ISA_SKX_AVX512, 1, GKF_DCF);
  DECL_U8S8_KCONV_TBL(INT8_F32, int8_t, 16, 4, ISA_SKX_AVX512, 2, GKF_DCF);
  DECL_U8S8_KCONV_TBL(INT8_F32, uint8_t, 16, 4, ISA_SKX_AVX512, 1, GKF_DCF);
  DECL_U8S8_KCONV_TBL(INT8_F32, uint8_t, 16, 4, ISA_SKX_AVX512, 2, GKF_DCF);
  ...
  DECL_U8S8_KCONV_TBL(INT8_F32, float, 16, 4, ISA_SKX_AVX512, 1, GKF_FBF); // direct, nhwc->nhwc, int8-conv
  DECL_U8S8_KCONV_TBL(INT8_F32, float, 16, 4, ISA_SKX_AVX512, 2, GKF_FBF);
  DECL_U8S8_KCONV_TBL(INT8_F32, int8_t, 16, 4, ISA_SKX_AVX512, 1, GKF_FBF);
  DECL_U8S8_KCONV_TBL(INT8_F32, int8_t, 16, 4, ISA_SKX_AVX512, 2, GKF_FBF);
  DECL_U8S8_KCONV_TBL(INT8_F32, uint8_t, 16, 4, ISA_SKX_AVX512, 1, GKF_FBF);
  DECL_U8S8_KCONV_TBL(INT8_F32, uint8_t, 16, 4, ISA_SKX_AVX512, 2, GKF_FBF);
