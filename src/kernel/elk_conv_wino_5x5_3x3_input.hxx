...
class convolution_winograd_kernel_base<InputType, WeightsType, OutputType, BiasType,
    TarrayType, ISA_SKX_AVX512, v, 7, 3> {
protected:
...
inline void convolution_winograd_kernel_base<
  ...
  // Inputs
  __m<V> f00, f01, f02, f03, f04, f05, f06,
...
__trans_inputa(
  ...
  // lazy initialize
  __m<V> z5, z5_8, z5_16, z25_4, z25_8, z25_16, z10, z25_2;
...
#define OP(m,n) f(m, n) = F(m, n)
  ...
  case 1:
    ...
    break;
  case 2:
    z5 = _mm<V>::set_ps(IMM_BCAST16(5.0f));
    z5_8 = _mm<V>::set_ps(IMM_BCAST16(5.0f / 8.0f));
    z5_16 = _mm<V>::set_ps(IMM_BCAST16(5.0f / 16.0f));
    z25_4 = _mm<V>::set_ps(IMM_BCAST16(25.0f / 4.0f));
    z25_8 = _mm<V>::set_ps(IMM_BCAST16(25.0f / 8.0f));
    z25_16 = _mm<V>::set_ps(IMM_BCAST16(25.0f / 16.0f));
  ...
  case 4:
    z5 = _mm<V>::set_ps(IMM_BCAST16(5.0f));
    z10 = _mm<V>::set_ps(IMM_BCAST16(10.0f));
    z5_8 = _mm<V>::set_ps(IMM_BCAST16(5.0f / 8.0f));
    z25_2 = _mm<V>::set_ps(IMM_BCAST16(25.0f / 2.0f));
    z25_4 = _mm<V>::set_ps(IMM_BCAST16(25.0f / 4.0f));
    z25_8 = _mm<V>::set_ps(IMM_BCAST16(25.0f / 8.0f));
