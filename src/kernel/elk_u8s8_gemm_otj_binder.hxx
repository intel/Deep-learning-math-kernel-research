...
struct u8s8_gemm_kernel_binder {
  ...
  DECL_U8S8_KGEMM_TBL(INT8_F32, 16, 4, ISA_SKX_AVX512, 1, GKF_DCD); // direct, blocked, int8-gemm
  DECL_U8S8_KGEMM_TBL(INT8_F32, 16, 4, ISA_SKX_AVX512, 2, GKF_DCD); // direct, blocked, int8-gemm
