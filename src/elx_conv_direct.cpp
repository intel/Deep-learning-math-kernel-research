    ...
    : elx_conv_t(dc)
{
  ...
  printf("V=%d, Or=%d, O2=%d (O=%d, O1=%d), O3=%d, O4=%d, O2r=%d, O3r=%d, OC=%d, g=%d\n",
      V, this->Or, this->O2, this->O, this->O1,
      this->O3, this->O4, this->O2r, this->O3r, this->OC, this->g);
}
...
int Instance_elx_conv_direct_t::prepare_execute_opt()
{
  ...
  switch (xopt_) {
  case 0xb060:
    toutput_size_ = this->I4 * this->n * this->g * this->OC * this->oh * this->ow * sizeof(ToutputType);
  case 0xa060:
  case 0xd060:
      ...
      iter_each (_O1, this->O1) {
        ...
        if (is_Or) {
          __trans_weights_Or_post(&md5(aweights2, _O4, _O3, _O1, this->O - 1, 0),
              tweights, _g, _O4, _I4, _O3, _I3, _kh, _kw, _O1, _I2, _iV, this->O - 1);
        }
      }}}}
    ...
    int _ht, int _wt)
{
  ...
  if (this->input_fmt == nhwc) {
    ...
    MD3(InputType, ainput1, &md4(ainput0, _ih, _iw, 0, 0), this->I4, this->I3, this->I2 * V);
    ...
    TweightsType *weights, BiasType *bias, int _I4, int _O4, int _ht, int _wt)
{
  ...
  // output:  O3*, O2, ht*, wt*, T, V
  MD5(TweightsType, aweights, weights, this->O3, this->I3, this->kh, this->kw,
      this->O2 * this->I2 * V * V);
  ...
  if (this->input_fmt == nhwc) {
    ...
    iter_each (_I3, this->I3) {
      bool oc3_has_Or
          = this->Or != V && _O4 == this->O4 - 1 && _O3 == this->O3 - 1;
      if (_I4 == 0 && _I3 == 0) {
      ...
      for (int _kh = khs; _kh < khe; ++_kh) {
        ...
        for (int _kw = 0; _kw < this->kw; ++_kw) {
          ...
          MD4(InputType, ainput1, &md4(ainput0, _ih, _iws, 0, 0), this->I4,
              this->I3, this->I2, V);
          MD4(OutputType, aoutput1, &md4(aoutput0, _ht, _ows, 0, 0), this->O4,
              this->O3, this->O2, V);
          ker_gemm_[_wt][_kw](
              *this, &md4(aoutput1, 0, _O3, 0, 0), &md4(ainput1, 0, _I3, 0, 0),
    ...
    MD5(InputType, ainput, input, this->I3, this->I2, this->ih, this->iw, V);
    MD5(OutputType, aoutput, output, this->O3, this->O2, this->ht, this->ow, V);
    ...
    iter_each (_I3, this->I3) {
      ...
      for (int _kh = khs; _kh < khe; ++_kh) {
        ...
        for (int _kw = 0; _kw < this->kw; ++_kw) {
          ...
          while (_iws < 0) _iws += this->ws;
          auto _ows = (_iws + this->lp - _kw) / this->ws;
          ker_gemm_[_wt][_kw](*this, &md5(aoutput, _O3, 0, _ht, _ows, 0),
