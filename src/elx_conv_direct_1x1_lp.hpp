...
public:
  ...
  inline void __trans_weights_s8_blocked(TscaleType *, int8_t *, WeightsType *);
  void trans_weights_s8(TscaleType *, int8_t *, WeightsType *);
  ...
  u8s8_gemm_kernel_binder::kgemm<TarrayTypes> *ker_u8s8_gemm_I_O_T_;
  u8s8_gemm_kernel_binder::kgemm<TarrayTypes> *ker_u8s8_gemm_I_O_Tr_;
