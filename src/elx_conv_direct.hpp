...
class elx_conv_direct_t : public elx_conv_t<UserTypes> {
  ...
  void trans_weights_blocked_to_compact(TweightsType *tweights, WeightsType *weights);

  void conv_a060(OutputType *output, InputType *input, TweightsType *weights, BiasType *bias, int _ic4, int _oc4, int _ht, int _wt);

  void gemm_d060_blocked_input(OutputType *toutput, InputType *tinput, TweightsType *tweights, BiasType *bias, int _ic4, int _oc4, int _ht, int _wt);
  void gemm_d060_nchw_input(OutputType *toutput, InputType *tinput, TweightsType *tweights, BiasType *bias, int _ic4, int _oc4, int _ht, int _wt);
  ...
  gemm_kernel_binder::kgemm<TarrayTypes> *ker_gemm_left_I_O_T_;
  gemm_kernel_binder::kgemm<TarrayTypes> *ker_gemm_left_I_O_Tr_;
  gemm_kernel_binder::kgemm<TarrayTypes> *ker_gemm_left_IrO_T_;
  gemm_kernel_binder::kgemm<TarrayTypes> *ker_gemm_left_IrO_Tr_;
  gemm_kernel_binder::kgemm<TarrayTypes> *ker_gemm_right_I_O_T_;
  gemm_kernel_binder::kgemm<TarrayTypes> *ker_gemm_right_I_O_Tr_;
  gemm_kernel_binder::kgemm<TarrayTypes> *ker_gemm_right_IrO_T_;
  gemm_kernel_binder::kgemm<TarrayTypes> *ker_gemm_right_IrO_Tr_;
