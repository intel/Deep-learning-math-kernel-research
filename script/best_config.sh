...
if [ "x$m" = "xvgg-n1-8180-1s" ]; then
  ...
  # vgg19_conv3_1, 7.3T
  ./script/run.sh -c -i128 -h56 -o256 -H56 -v0 -n1 --blk-i=8 --blk-o=8 --blk-t=26 --execution-mode=0xa061
  # vgg19_conv3_2, 7.3T
  ./script/run.sh -c -i256 -h56 -o256 -H56 -v0 -n1 --blk-i=8 --blk-o=8 --blk-t=26 --execution-mode=0xa061
  # vgg19_conv4_1, 5.6T
  #./script/run.sh -c -i256 -h28 -o512 -H28 -v0 -n1 --blk-i=8 --blk-o=8 --blk-t=15 --execution-mode=0xa061
  # vgg19_conv4_1, 6.1T
...
if [ "x$m" = "xvgg-n1-8180-2s" ]; then
  ...
  ./script/run.sh -c -i128 -h112 -o128 -H112 -v0 -n1 --blk-i=8 --blk-o=8 --blk-t=26 --execution-mode=0xa040
  # vgg19_conv3_1, 13.0T
  ./script/run.sh -c -i128 -h56 -o256 -H56 -v0 -n1 --blk-i=8 --blk-o=4 --blk-t=26 --execution-mode=0xa061
  # vgg19_conv3_2, 12.6T
...
if [ "x$m" = "xresnet-n1-8180-1s" ]; then
  ...
  ./script/run.sh -c -i64 -h56 -o64 -H56 -v0 -n1 --execution-mode=0xa061 --blk-i=4 --blk-o=2 --blk-t=26
  # resnet50_res3a_branch2b, 4.4T
  ./script/run.sh -c -i128 -h28 -o128 -H28 -v0 -n1 --execution-mode=0xa061 --blk-i=8 --blk-o=2 --blk-t=15
...
if [ "x$m" = "xresnet-n64-8180-2s" ]; then
  ...
  ./script/run.sh -c -i256 -h14 -o256 -H14 -v0 -n64 --execution-mode=0xa061 --blk-i=8 --blk-o=4 --blk-t=23
