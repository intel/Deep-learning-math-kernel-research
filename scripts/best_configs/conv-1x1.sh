...
# ssd_300_voc0712:fc7
NSOCKETS=1 ./scripts/run.sh -c -n1 -i1024 -o1024 -h19 -k1 -K1 -H19 -p0 -P0 -s1 -b1 -r0 -v0 -adirect_1x1 --blk-i=32 --blk-o=2 --blk-t=13 --execution-mode=0xe001 --pat-o=4 $COMMON
...
# ssd_300_voc0712:fc7
NSOCKETS=1 ./scripts/run.sh -c -n64 -i1024 -o1024 -h19 -k1 -K1 -H19 -p0 -P0 -s1 -b1 -r0 -v0 -adirect_1x1 --blk-i=32 --blk-o=2 --blk-t=13 --execution-mode=0xe001 --pat-o=4 $COMMON
# ssd_300_voc0712:conv6_1
NSOCKETS=1 ./scripts/run.sh -c -n64 -i1024 -o256  -h19 -k1 -K1 -H19 -p0 -P0 -s1 -b1 -r0 -v0 -adirect_1x1 --blk-i=32 --blk-o=2 --blk-t=13 --execution-mode=0xe001 --pat-o=8 $COMMON
# ssd_300_voc0712:conv7_1
...
# ssd_300_voc0712:conv8_1
NSOCKETS=1 ./scripts/run.sh -c -n64 -i256  -o128  -h5  -k1 -K1 -H5  -p0 -P0 -s1 -b1 -r0 -v0 -adirect_1x1 --blk-i=16 --blk-o=4 --blk-t=5 --execution-mode=0xe001 --pat-o=1 $COMMON
# ssd_300_voc0712:conv9_1
