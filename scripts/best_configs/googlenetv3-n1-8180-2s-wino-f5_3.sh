...
NSOCKETS=2 ./scripts/run.sh -c -i32 -h149 -o32 -H147 -n1 --blk-i=2 --blk-o=2 --flt-t=17 --tile-size=7 --execution-mode=0xa061 --output-as-blocked=true -p0 -P0 $COMMON
sleep 1
# googlenet_v3:conv_2_2_conv2d, ['ic', '32', 'ih', '147', 'oc', '64', 'oh', '147', 'kh', '3', 'ph', '1']
NSOCKETS=2 ./scripts/run.sh -c -i32 -h147 -o64 -H147 -n1 --blk-i=2 --blk-o=4 --flt-t=17 --tile-size=7 --execution-mode=0xa061 $COMMON
sleep 1
