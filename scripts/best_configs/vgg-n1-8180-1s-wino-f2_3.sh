...
NSOCKETS=1 ./scripts/run.sh -c -i64 -h224 -o64 -H224 -n1 --blk-i=4 --blk-o=2 --flt-t=30 --tile-size=4 --execution-mode=0xa040 --output-as-blocked=true $COMMON
sleep 1
# vgg19_conv2_1, 7.3T   tflops=5.85272
NSOCKETS=1 ./scripts/run.sh -c -i64 -h112 -o128 -H112 -n1 --blk-i=4 --blk-o=8 --flt-t=28  --tile-size=4 --execution-mode=0xa040 $COMMON
sleep 1
# vgg19_conv2_2, 7.4T   tflops=5.92653
NSOCKETS=1 ./scripts/run.sh -c -i128 -h112 -o128 -H112 -n1 --blk-i=8 --blk-o=2 --flt-t=28 --tile-size=4 --execution-mode=0xa040 $COMMON
sleep 1
# vgg19_conv3_1, 7.3T   tflops=6.08779
NSOCKETS=1 ./scripts/run.sh -c -i128 -h56 -o256 -H56 -n1 --blk-i=8 --blk-o=16 --flt-t=28 --pat-o=1 --tile-size=4 --execution-mode=0xa061 --output-as-blocked=true $COMMON
sleep 1
# vgg19_conv3_2, 7.3T  tflops=6.33066 
NSOCKETS=1 ./scripts/run.sh -c -i256 -h56 -o256 -H56 -n1 --blk-i=8 --blk-o=1 --flt-t=28 --pat-o=16 --tile-size=4 --execution-mode=0xa060 $COMMON
sleep 1
