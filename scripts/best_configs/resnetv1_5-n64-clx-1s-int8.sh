...
# conv2d_2
NSOCKETS=1 ./scripts/run.sh -c -i64 -h56 -o64 -H56 -k1 -K1 -s1 -S1 -p0 -P0 -n64 -adirect_1x1 --execution-mode=0xc160 --blk-i=4 --blk-o=2 --flt-o=2 --flt-t=12 --pat-o=1 $COMMON --data-type-cfg=U8F32S8F32 --sampling-kind=2
# conv2d_1, conv2d_4, conv2d_7, conv2d_10
NSOCKETS=1 ./scripts/run.sh -c -i64 -h56 -o256 -H56 -k1 -K1 -s1 -S1 -p0 -P0 -n64 -adirect_1x1 --execution-mode=0xc160 --blk-i=4 --blk-o=8 --flt-o=2 --flt-t=12 --pat-o=1 $COMMON --data-type-cfg=U8F32S8F32 --sampling-kind=2
# conv2d_5, conv2d_8
NSOCKETS=1 ./scripts/run.sh -c -i256 -h56 -o64 -H56 -k1 -K1 -s1 -S1 -p0 -P0 -n64 -adirect_1x1 --execution-mode=0xc160 --blk-i=16 --blk-o=2 --flt-o=2 --flt-t=11 --pat-o=1 $COMMON --data-type-cfg=U8F32S8F32 --sampling-kind=2
# conv2d_12
NSOCKETS=1 ./scripts/run.sh -c -i256 -h56 -o128 -H56 -k1 -K1 -s1 -S1 -p0 -P0 -n64 -adirect_1x1 --execution-mode=0xc160 --blk-i=16 --blk-o=2 --flt-o=2 --flt-t=11 --pat-o=1 $COMMON --data-type-cfg=U8F32S8F32 --sampling-kind=2

echo "Compute conv: 1x1 s1 h28"
# conv2d_14, conv2d_17, conv2d_20, conv2d_23
NSOCKETS=1 ./scripts/run.sh -c -i128 -h28 -o512 -H28 -k1 -K1 -s1 -S1 -p0 -P0 -n64 -adirect_1x1 --execution-mode=0xc160 --blk-i=8 --blk-o=4 --flt-o=2 --flt-t=12 --pat-o=1 $COMMON --data-type-cfg=U8F32S8F32 --sampling-kind=2
# conv2d_15, conv2d_18, conv2d_21
NSOCKETS=1 ./scripts/run.sh -c -i512 -h28 -o128 -H28 -k1 -K1 -s1 -S1 -p0 -P0 -n64 -adirect_1x1 --execution-mode=0xc160 --blk-i=32 --blk-o=4 --flt-o=2 --flt-t=12 --pat-i=1 --pat-o=1 $COMMON --data-type-cfg=U8F32S8F32 --sampling-kind=2 --output-format=nhwc
# conv2d_25
NSOCKETS=1 ./scripts/run.sh -c -i512 -h28 -o256 -H28 -k1 -K1 -s1 -S1 -p0 -P0 -n64 -adirect_1x1 --execution-mode=0xc160 --blk-i=32 --blk-o=4 --flt-o=4 --flt-t=6 --pat-i=1 --pat-o=1 $COMMON --data-type-cfg=U8F32S8F32 --sampling-kind=2
...
# conv2d_44
NSOCKETS=1 ./scripts/run.sh -c -i1024 -h14 -o512 -H14 -k1 -K1 -s1 -S1 -p0 -P0 -n64 -adirect_1x1 --execution-mode=0xc160 --blk-i=64 --blk-o=8 --flt-o=4 --flt-t=6 --pat-i=1 --pat-o=1 $COMMON --data-type-cfg=U8F32S8F32 --sampling-kind=2 --input-format=nhwc --output-format=nhwc
...
# FC
NSOCKETS=1 ./scripts/run.sh -c -i2048 -h8 -o1008 -H8 -k1 -K1 -s1 -S1 -p0 -P0 -n1 -adirect --execution-mode=0xd160 --blk-i=128 --blk-o=1 --flt-o=3 --flt-t=4 --pat-i=1 --pat-o=1 $COMMON --data-type-cfg=U8F32F32F32 --sampling-kind=2 --input-format=nhwc --output-format=nhwc
