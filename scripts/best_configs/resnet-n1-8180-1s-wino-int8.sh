...
NSOCKETS=1 ./scripts/run.sh -c -i64 -h56 -o64 -H56 -n1 --tile-size=6 --execution-mode=0xa161 --blk-i=4 --blk-o=1 --flt-o=2 --flt-t=7 --pat-o=1 --output-as-blocked=true $COMMON --data-type-cfg=U8F32S8F32 --sampling-kind=2
...
NSOCKETS=0 ./scripts/run.sh -c -i66 -h56 -o64 -H56 -n1 --tile-size=6 --execution-mode=0xa161 --blk-i=5 --blk-o=1 --flt-o=2 --flt-t=7 --pat-o=1 --output-as-blocked=true $COMMON --input-format=nchw --weights-format=oihw --data-type-cfg=U8F32S8F32 --sampling-kind=2
