...
# vgg19_conv1_2, 12.8T
NSOCKETS=2 ./scripts/run.sh -c -i64 -h224 -o64 -H224 -n1 --blk-i=4 --blk-o=4 --flt-t=19 --tile-size=7 --execution-mode=0xa040 --output-as-blocked=true $COMMON
sleep 1
# vgg19_conv2_1, 13.5T
...
sleep 1
# vgg19_conv3_2, 12.6T
NSOCKETS=2 ./scripts/run.sh -c -i256 -h56 -o256 -H56 -n1 --blk-i=8 --blk-o=8 --flt-t=12 --pat-o=2 --tile-size=7 --execution-mode=0xa0e0 $COMMON
sleep 1
# vgg19_conv4_1, 10.2T
