...
NSOCKETS=2 ./scripts/run.sh -c -i32 -h149 -o32 -H147 -n64 --blk-i=2 --blk-o=2 --flt-t=25 --tile-size=6 --execution-mode=0xa040 -p0 -P0 $COMMON  
sleep 1
# googlenet_v3:conv_2_2_conv2d, ['ic', '32', 'ih', '147', 'oc', '64', 'oh', '147', 'kh', '3', 'ph', '1']
NSOCKETS=2 ./scripts/run.sh -c -i32 -h147 -o64 -H147 -n64 --blk-i=2 --blk-o=4 --flt-t=28 --tile-size=6 --execution-mode=0xa040 $COMMON 
sleep 1
