...
NSOCKETS=2 ./scripts/run.sh -c -i64 -h56 -o64 -H56 -n64 --tile-size=7 --execution-mode=0xa061 --blk-i=4 --blk-o=4 --flt-t=15 $COMMON
sleep 1
# resnet50_res3a_branch2b, 11.9T
NSOCKETS=2 ./scripts/run.sh -c -i128 -h28 -o128 -H28 -n64 --tile-size=7 --execution-mode=0xa061 --blk-i=8 --blk-o=8 --flt-t=21 $COMMON
sleep 1
