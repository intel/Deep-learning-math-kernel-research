...
NSOCKETS=1 ./scripts/run.sh -c -i3 -h300 -o64 -H300 -n1 --tile-size=4 --execution-mode=0xa061 --blk-i=1 --blk-o=4 --flt-t=30 $COMMON
sleep 1
#"ssd_300_voc0712:conv1_2":ic64 ih300 oc64 oh300 kh3 ph1n"
NSOCKETS=1 ./scripts/run.sh -c -i64 -h300 -o64 -H300 -n1 --tile-size=4 --execution-mode=0xa061 --blk-i=4 --blk-o=4 --flt-t=30 $COMMON
sleep 1
...
NSOCKETS=1 ./scripts/run.sh -c -i1024 -h19 -o24 -H19 -n1 --tile-size=4 --execution-mode=0xa061 --blk-i=16 --blk-o=2 --flt-t=4 $COMMON
sleep 1
