...
NSOCKETS=1 ./scripts/run.sh -c -i32 -h149 -o32 -H147 -n1 --blk-i=2 --blk-o=2 --blk-t=25 --tile-size=6 --execution-mode=0xa040 --output-as-blocked=true -p0 -P0 $COMMON 
sleep 1
# googlenet_v3:conv_2_2_conv2d, ['ic', '32', 'ih', '147', 'oc', '64', 'oh', '147', 'kh', '3', 'ph', '1']
NSOCKETS=1 ./scripts/run.sh -c -i32 -h147 -o64 -H147 -n1 --blk-i=2 --blk-o=4 --blk-t=28 --tile-size=6 --execution-mode=0xa040 $COMMON  
sleep 1
# googlenet_v3:conv_4_4_conv2d, ['ic', '80', 'ih', '73', 'oc', '192', 'oh', '71', 'kh', '3']
NSOCKETS=1 ./scripts/run.sh -c -i80 -h73 -o192 -H71 -n1 --blk-i=5 --blk-o=2 --pat-o=3 --blk-t=12 --tile-size=6 --execution-mode=0xa061 --output-as-blocked=true -p0 -P0 $COMMON   
sleep 1
# googlenet_v3:mixed_tower_1_conv_1_conv2d, ['ic', '64', 'ih', '35', 'oc', '96', 'oh', '35', 'kh', '3', 'ph', '1']
NSOCKETS=1 ./scripts/run.sh -c -i64 -h35 -o96 -H35 -n1 --blk-i=4 --blk-o=3 --blk-t=6 --pat-o=2 --tile-size=6 --execution-mode=0xa061 --output-as-blocked=true $COMMON  
sleep 1
