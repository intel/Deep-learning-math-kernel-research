...
NSOCKETS=1 ./scripts/run.sh -c -i128 -h28 -o128 -H28 -n1 --tile-size=6 --execution-mode=0xa072 --blk-i=1 --blk-o=1 --flt-o=2 --flt-t=7 --pat-i=8 --pat-o=4 --output-as-blocked=true $COMMON
sleep 1
